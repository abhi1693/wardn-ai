...
MCP_RUNTIME_PUBLIC_EGRESS_PER_WORKSPACE = "mcp_runtime_public_egress.per_workspace"
MCP_RUNTIME_PRIVATE_EGRESS_PER_WORKSPACE = "mcp_runtime_private_egress.per_workspace"
MCP_RUNTIME_KUBERNETES_API_EGRESS_PER_WORKSPACE = (
    "mcp_runtime_kubernetes_api_egress.per_workspace"
)
MCP_RUNTIME_NETWORK_ISOLATION_DISABLE_PER_WORKSPACE = (
    "mcp_runtime_network_isolation_disable.per_workspace"
)
MCP_RUNTIME_CUSTOM_EGRESS_RULES_PER_INSTALLATION = (
    "mcp_runtime_custom_egress_rules.per_installation"
)
...
SUPPORTED_LIMIT_KEYS = {
    ...
    MCP_RUNTIME_PUBLIC_EGRESS_PER_WORKSPACE,
    MCP_RUNTIME_PRIVATE_EGRESS_PER_WORKSPACE,
    MCP_RUNTIME_KUBERNETES_API_EGRESS_PER_WORKSPACE,
    MCP_RUNTIME_NETWORK_ISOLATION_DISABLE_PER_WORKSPACE,
    MCP_RUNTIME_CUSTOM_EGRESS_RULES_PER_INSTALLATION,
