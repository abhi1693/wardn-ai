 ...
 */
export const llmProviderCredentialsList = async (organizationId: string, options?: Parameters<typeof apiRequest>[1]): Promise<LLMProviderCredentialListResponse> => {
 ...
 */
export const llmProviderCredentialsChatgptDeviceStart = async (organizationId: string, options?: Parameters<typeof apiRequest>[1]): Promise<ChatGPTDeviceAuthorizationStartResponse> => {
...
export const llmProviderCredentialsDelete = async (organizationId: string,
    credentialId: string, options?: Parameters<typeof apiRequest>[1]): Promise<void> => {
...
export const llmProviderCredentialsListModels = async (organizationId: string,
    credentialId: string, options?: Parameters<typeof apiRequest>[1]): Promise<LLMProviderModelListResponse> => {
...
export const llmProviderCredentialsValidate = async (organizationId: string,
    credentialId: string, options?: Parameters<typeof apiRequest>[1]): Promise<LLMProviderCredentialValidationResponse> => {
