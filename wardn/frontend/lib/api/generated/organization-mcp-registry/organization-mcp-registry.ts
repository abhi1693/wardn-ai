...
export const organizationMcpRegistryListServers = async (organizationId: string,
    params?: OrganizationMcpRegistryListServersParams, options?: Parameters<typeof apiRequest>[1]): Promise<MCPRegistryServerListResponse> => {
...
export const organizationMcpRegistryListServerVersions = async (organizationId: string,
    serverName: string,
    params?: OrganizationMcpRegistryListServerVersionsParams, options?: Parameters<typeof apiRequest>[1]): Promise<MCPRegistryServerListResponse> => {
...
export const organizationMcpRegistryDeleteServerVersion = async (organizationId: string,
    serverName: string,
    version: string, options?: Parameters<typeof apiRequest>[1]): Promise<void> => {
...
export const organizationMcpRegistryGetServerVersion = async (organizationId: string,
    serverName: string,
    version: string,
    params?: OrganizationMcpRegistryGetServerVersionParams, options?: Parameters<typeof apiRequest>[1]): Promise<MCPRegistryServerResponse> => {
...
export const organizationMcpRegistrySetDefaultServerVersion = async (organizationId: string,
    serverName: string,
    version: string, options?: Parameters<typeof apiRequest>[1]): Promise<MCPRegistryServerResponse> => {
