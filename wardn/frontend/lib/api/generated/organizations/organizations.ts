 ...
 */
export const organizationsList = async ( options?: Parameters<typeof apiRequest>[1]): Promise<OrganizationListResponse> => {
 ...
 */
export const organizationsGet = async (organizationId: string, options?: Parameters<typeof apiRequest>[1]): Promise<OrganizationRead> => {
 ...
 */
export const workspacesList = async (organizationId: string, options?: Parameters<typeof apiRequest>[1]): Promise<WorkspaceListResponse> => {
...
export const workspacesGet = async (organizationId: string,
    workspaceId: string, options?: Parameters<typeof apiRequest>[1]): Promise<WorkspaceRead> => {
