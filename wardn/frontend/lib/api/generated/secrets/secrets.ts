...
export const secretHandlesList = async (organizationId: string,
    params?: SecretHandlesListParams, options?: Parameters<typeof apiRequest>[1]): Promise<SecretHandleListResponse> => {
...
export const secretHandlesDelete = async (organizationId: string,
    handleId: string, options?: Parameters<typeof apiRequest>[1]): Promise<void> => {
...
export const secretHandlesGet = async (organizationId: string,
    handleId: string, options?: Parameters<typeof apiRequest>[1]): Promise<SecretHandleRead> => {
...
export const secretHandlesValidate = async (organizationId: string,
    handleId: string, options?: Parameters<typeof apiRequest>[1]): Promise<SecretValidationResponse> => {
...
export const secretStoresList = async (organizationId: string,
    params?: SecretStoresListParams, options?: Parameters<typeof apiRequest>[1]): Promise<SecretStoreListResponse> => {
...
export const secretStoresDelete = async (organizationId: string,
    storeId: string, options?: Parameters<typeof apiRequest>[1]): Promise<void> => {
...
export const secretStoresGet = async (organizationId: string,
    storeId: string, options?: Parameters<typeof apiRequest>[1]): Promise<SecretStoreRead> => {
...
export const secretStoresValidate = async (organizationId: string,
    storeId: string, options?: Parameters<typeof apiRequest>[1]): Promise<SecretValidationResponse> => {
