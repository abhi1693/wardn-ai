 ...
 */
export const organizationObservabilityListLlmModelPrices = async (organizationId: string, options?: Parameters<typeof apiRequest>[1]): Promise<LLMModelPriceListResponse> => {
...
export const organizationObservabilityPrefillLlmModelPrice = async (organizationId: string,
    params: OrganizationObservabilityPrefillLlmModelPriceParams, options?: Parameters<typeof apiRequest>[1]): Promise<LLMModelPricePrefillResponse> => {
...
export const organizationObservabilityDeleteLlmModelPrice = async (organizationId: string,
    priceId: string, options?: Parameters<typeof apiRequest>[1]): Promise<void> => {
