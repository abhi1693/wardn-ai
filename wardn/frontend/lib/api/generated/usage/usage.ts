...
export const organizationUsageSummary = async (organizationId: string,
    params?: OrganizationUsageSummaryParams, options?: Parameters<typeof apiRequest>[1]): Promise<UsageSummaryResponse> => {
...
export const workspaceUsageSummary = async (organizationId: string,
    workspaceId: string,
    params?: WorkspaceUsageSummaryParams, options?: Parameters<typeof apiRequest>[1]): Promise<UsageSummaryResponse> => {
