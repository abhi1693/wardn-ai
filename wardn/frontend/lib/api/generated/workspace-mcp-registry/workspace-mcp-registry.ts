...
export const workspaceMcpRegistryUninstallServerConfig = async (organizationId: string,
    workspaceId: string,
    installationId: string, options?: Parameters<typeof apiRequest>[1]): Promise<void> => {
...
export const workspaceMcpRegistryListInstalledServerTools = async (organizationId: string,
    workspaceId: string,
    installationId: string, options?: Parameters<typeof apiRequest>[1]): Promise<MCPServerInstallationToolsResponse> => {
...
export const workspaceMcpRegistryListInstalledServers = async (organizationId: string,
    workspaceId: string,
    params?: WorkspaceMcpRegistryListInstalledServersParams, options?: Parameters<typeof apiRequest>[1]): Promise<MCPServerInstallationListResponse> => {
...
export const workspaceMcpRegistryUninstallServer = async (organizationId: string,
    workspaceId: string,
    serverName: string, options?: Parameters<typeof apiRequest>[1]): Promise<void> => {
